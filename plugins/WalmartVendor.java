...
public class WalmartVendor implements IVendor {
    ...
    public Map<String, String> getProductInfo(String url) {
        ...
        try {
            ...
            ProcessBuilder pb = new ProcessBuilder("python", String.format("python/searchWalmart.py"), url);
            Process p = pb.start();
    ...
    public String getUrl(String query) {
        String url = "";
        try {
            ProcessBuilder pb = new ProcessBuilder("python", String.format("python/searchWalmart.py"), query);
            Process p = pb.start();
            BufferedReader in = new BufferedReader(new InputStreamReader(p.getInputStream()));
            url = in.readLine();
        } catch (IOException ex) {
