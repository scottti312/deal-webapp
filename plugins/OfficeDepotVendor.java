...
public class OfficeDepotVendor implements IVendor {
    public Map<String, String> searchType(String input) {
        ...
        productInfo.put("Vendor", "OfficeDepot");
    ...
    public Map<String, String> getProductInfo(String url) {
        ...
        try {
            ...
            ProcessBuilder pb = new ProcessBuilder("python", String.format("python/searchOfficeDepot.py"), url);
            Process p = pb.start();
    ...
    public String getUrl(String query) {
        String url = "";
        try {
            ProcessBuilder pb = new ProcessBuilder("python", String.format("python/searchOfficeDepot.py"), query);
            Process p = pb.start();
            BufferedReader in = new BufferedReader(new InputStreamReader(p.getInputStream()));
            url = in.readLine();
        } catch (IOException ex) {
