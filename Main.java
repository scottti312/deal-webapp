...
class Main {
    public static void main(String[] args) {
        ...
        Map<String, String> dict = av.search("https://www.bestbuy.com/site/samsung-odyssey-g7-28-ips-1ms-4k-uhd-freesync-g-sync-compatible-gaming-monitor-with-hdr-black/6463480.p?skuId=6463480", "BestBuy");
        System.out.println(dict.get("Title"));
        System.out.println(dict.get("Price"));
        System.out.println(dict.get("Image"));
